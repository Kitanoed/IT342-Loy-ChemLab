...
class AuthControllerTest {
    ...
    @MockBean
    private edu.cit.loy.chemlab.security.JwtUtil jwtUtil;

    @MockBean
    private edu.cit.loy.chemlab.repository.UserRepository userRepository;
    ...
    @Test
    void loginReturnsUnauthorizedOnAuthFailure() throws Exception {
        when(authService.login(any(LoginRequest.class)))
                .thenReturn(AuthResponse.error("AUTH-001", "Invalid credentials", "Email or password is incorrect"));

        LoginRequest request = new LoginRequest("student@example.com", "wrong");
