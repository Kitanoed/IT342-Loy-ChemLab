...
public class BulkJobValidationResponse {
    ...
    public BulkJobStatus getStatus() { return status; }
    public void setStatus(BulkJobStatus status) { this.status = status; }
    ...
    public static class RowResult {
        ...
        public BulkRowStatus getStatus() { return status; }
        public void setStatus(BulkRowStatus status) { this.status = status; }
    ...
    public static class Message {
        ...
        public Message() {}
        public Message(String code, String field, String message) { this.code = code; this.field = field; this.message = message; }
